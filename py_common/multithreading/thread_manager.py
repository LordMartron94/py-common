...
class ThreadManager:
    ...
    def _work_batch(self, batch: T, total_to_process: int):
    ...
    def work_batches(self, batches: List[T]):
        threads: List[Thread] = []
        ...
        for batch in batches:
            thread = threading.Thread(target=self._work_batch, args=(batch,total_to_process,))
